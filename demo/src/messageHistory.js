export default [
  { type: 'text', author: `giuliandrimba`, id: 0, data: { text: `Why don't they have salsa on the table?` } },
  { type: 'text', author: `mattmezza`, id: 1, data: { text: `What do you need salsa for?` } },
  { type: 'text', author: `giuliandrimba`, id: 2, data: { text: `Salsa is now the number one condiment in America.` } },
  ...
  { type: 'text', author: `giuliandrimba`, id: 4, data: { text: `You know it must be impossible for a Spanish person to order seltzer and not get salsa. 'I wanted seltzer, not salsa.'` } },
  ...
  { type: 'text', author: `giuliandrimba`, id: 6, data: { text: `See, this should be a show. This is the show. ` } },
  { type: 'text', author: `mattmezza`, id: 7, data: { text: `What?` } },
  { type: 'text', author: `giuliandrimba`, id: 8, data: { text: `This. Just talking.` } },
  { type: 'text', author: `mattmezza`, id: 9, data: { text: `Yeah, right.` } },
  { type: 'text', author: `giuliandrimba`, id: 10, data: { text: `I'm really serious. I think that's a good idea. ` } },
  { type: 'text', author: `mattmezza`, id: 11, data: { text: `Just talking? Well what's the show about?` } },
  { type: 'text', author: `giuliandrimba`, id: 12, data: { text: `It's about nothing.` } },
  ...
  { type: 'text', author: `giuliandrimba`, id: 18, data: { text: `Do you read me...`, meta: '✓✓ Read' } },
  { type: 'text', author: `giuliandrimba`, id: 19, data: { text: `...or not?`, meta: '✓ Delivered' } },
  { type: 'system', id: 20, data: { text: 'User changed security key', meta: '04-08-2018 15:57' } },
  { type: 'text', author: `support`, id: 21, data: { text: `What about suggestions?` }, reply: 20 }
]
